...
const LLMQueryComponent = () => {
  ...
  return (
    <div className="max-w-lg p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-center mb-6 text-blue-700">Ask LLM about Candidates</h2>
      ...
      {response && (
        <div className="mt-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded overflow-y-auto" style={{ maxHeight: '350px' }}>
