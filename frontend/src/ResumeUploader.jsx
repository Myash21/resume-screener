...
const ResumeUploader = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedFiles.length === 0 || !jobDescription) {
      alert(
        "Please select a folder with PDF files and provide a job description."
      );
      return;
    }
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg shadow-lg">
      ...
      {responseMessage && (
        <p className="mt-6 text-center text-lg text-blue-700 font-medium">
          {responseMessage}
        </p>
      )}
    </div>
